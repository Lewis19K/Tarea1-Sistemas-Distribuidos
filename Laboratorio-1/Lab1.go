...
func (s *server) EnviarEscuadron(ctx context.Context, msg *pb.ReqEnviarEscuadron) (*pb.ResEnviarEscuadron, error) {
...
func (s *server) EstadoLab(ctx context.Context, msg *pb.ReqEstadoLab) (*pb.ResEstadoLab, error) {
...
func main() {
	labName := "Laboratorio Renca (la lleva) - Chile"
	hostQ := "dist030"
