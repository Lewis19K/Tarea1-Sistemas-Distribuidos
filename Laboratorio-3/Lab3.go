...
func (s *server) EnviarEscuadron3(ctx context.Context, msg *pb.ReqEnviarEscuadron) (*pb.ResEnviarEscuadron, error) {
...
func (s *server) EstadoLab3(ctx context.Context, msg *pb.ReqEstadoLab) (*pb.ResEstadoLab, error) {
...
func main() {
	labName := "Laboratorio Kampala - Uganda"
	hostQ := "dist030"
