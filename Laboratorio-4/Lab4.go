...
func (s *server) EnviarEscuadron4(ctx context.Context, msg *pb.ReqEnviarEscuadron) (*pb.ResEnviarEscuadron, error) {
...
func (s *server) EstadoLab4(ctx context.Context, msg *pb.ReqEstadoLab) (*pb.ResEstadoLab, error) {
...
func main() {
	labName := "Laboratorio Pripiat - Rusia"
	hostQ := "dist030"
